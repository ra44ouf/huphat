    ...
    <main className="min-h-screen bg-shubuhat-green flex flex-col font-sans overflow-x-hidden relative">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <motion.div 
             ...
             className="absolute top-[-20%] right-[-10%] w-[70vw] h-[70vw] rounded-full bg-shubuhat-gold blur-[100px]"
          />
          <motion.div 
             animate={{ scale: [1, 1.3, 1], opacity: [0.1, 0.2, 0.1] }}
             transition={{ duration: 12, repeat: Infinity, ease: "easeInOut", delay: 2 }}
             className="absolute bottom-[-20%] left-[-10%] w-[60vw] h-[60vw] rounded-full bg-[#004d40] blur-[120px]"
          />
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-4 md:p-8 relative z-10 w-full max-w-6xl mx-auto my-6 md:my-10">
          ...
          >
              {/* Left Side: Right side for Register (Form) */}
                         ...
                         >
                             <div className="relative">
                                 ...
                                 <input 
                                     ...
                                     required 
                                     dir="ltr"
                                     className={`w-full py-4 rounded-2xl bg-white/5 border border-white/10 focus:border-shubuhat-gold/50 focus:bg-white/10 transition-all font-bold text-white placeholder:text-white/30 outline-none backdrop-blur-md text-right md:text-left ${lang === 'ar' ? 'pr-14 pl-6' : 'pl-14 pr-6 text-left mr-auto'}`}
                                 />
                             </div>
                         </motion.div>
                         ...
                         >
                             <div className="relative">
                                 ...
                                 <input 
                                     ...
                                     required 
                                     dir="ltr"
                                     className={`w-full py-4 rounded-2xl bg-white/5 border border-white/10 focus:border-shubuhat-gold/50 focus:bg-white/10 transition-all font-bold text-white placeholder:text-white/30 outline-none backdrop-blur-md text-right md:text-left ${lang === 'ar' ? 'pr-14 pl-14' : 'pl-14 pr-14 text-left mr-auto'}`}
                                 />
                                 <button 
                                     type="button"
